                  ...
                  >
                    ...
                    <div className={`relative bg-white/5 backdrop-blur-xl rounded-2xl p-4 md:p-8 border transition-all duration-300 ${activeIndex === index ? 'border-white/30' : 'border-white/10 hover:border-white/20'}`}>
                      <div className="mb-4 md:mb-6">
                        ...
                        <div className="flex flex-wrap items-center gap-2 md:gap-4 text-muted mb-3 md:mb-4">
                      ...
                      <div className="space-y-3 md:space-y-4">
                        <div>
                          <h4 className="text-accent font-semibold mb-2 text-sm md:text-base">Technologies</h4>
                          <div className="flex flex-wrap gap-1.5 md:gap-2">
                            {exp.technologies.map((tech, techIndex) => (
                              <span
                                key={techIndex}
                                className="px-2 md:px-3 py-0.5 md:py-1 text-xs md:text-sm bg-white/10 text-secondary rounded-full"
                              >
                                {tech}
                              </span>
                            ))}
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            <h4 className="text-accent font-semibold text-sm md:text-base">Key Achievements</h4>
                            <motion.button
                              onClick={(e) => {
                                e.stopPropagation();
                          ...
                          >
                            <ul className="space-y-2">
                              {exp.achievements.map((achievement, achievementIndex) => (
                                ...
                                >
                                  <FiChevronRight className="w-4 h-4 mt-1 text-accent" />
